<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(request('buscar'))
                <div class="mb-4 px-4 py-3 bg-brand-50 border border-brand-200 rounded-lg flex items-center justify-between">
                    <span class="text-brand-700">
                        <strong>{{ $productos->count() }}</strong> producto(s) encontrado(s) para "<strong>{{ request('buscar') }}</strong>"
                    </span>
                    <a href="{{ route('productos.index') }}" class="text-brand-600 hover:text-brand-800 text-sm font-medium">
                        Ver todos
                    </a>
                </div>
            @endif
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-sky-50/50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <span class="inline-block bg-brand-100 text-brand-700 rounded-full px-3 py-1 text-xs font-semibold">
