    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            <a href="{{ route('admin.users.index') }}"
                class="text-gray-600 hover:text-gray-900 font-medium sm:ml-auto">
                ← Volver
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-4 sm:py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                <div class="bg-gradient-to-r from-brand-300 to-brand-dark px-6 py-8">
                    <h3 class="text-white font-bold text-lg">Modificar Usuario</h3>
                    <p class="text-white/80 text-sm mt-1">Actualiza los detalles del usuario</p>
                </div>
                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST" class="p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="role" name="role"
                                ...
                                <option value="Control Stock" {{ old('role', $user->role) === 'Control Stock' ? 'selected' : '' }}>Control Stock</option>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mt-8">
                        <a href="{{ route('admin.users.index') }}"
                            class="flex-1 w-full sm:w-auto text-center bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-3 px-6 rounded-lg transition-colors duration-200">
                            Cancelar
                        </a>
                        <button type="submit"
                            class="flex-1 w-full sm:w-auto bg-brand-600 hover:bg-brand-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md">
                            Actualizar Usuario
                        </button>
                    </div>
                </form>
