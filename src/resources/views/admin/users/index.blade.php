    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.users.create') }}"
                class="inline-flex items-center gap-2 bg-gradient-to-r from-brand-300 to-sky-300 hover:from-brand-dark hover:to-sky-dark text-white font-bold py-3 px-6 rounded-lg shadow-md transition-all duration-200 transform hover:scale-105">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-sky-50/50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($user->role === 'ADMIN')
                                    <span class="inline-flex items-center gap-1 bg-purple-100 text-purple-700 rounded-full px-3 py-1 text-xs font-bold">
                                    ...
                                    <span class="inline-flex items-center gap-1 bg-amber-100 text-amber-700 rounded-full px-3 py-1 text-xs font-bold">Control Stock</span>
                                    @else
            ...
            <div class="bg-white rounded-xl shadow-md border border-sky-100 overflow-hidden">
                <div class="p-12 text-center">
                    ...
                    <a href="{{ route('admin.users.create') }}"
                        class="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-brand-300 to-sky-300 hover:from-brand-dark hover:to-sky-dark text-white font-bold py-2 px-6 rounded-lg transition-all duration-200 transform hover:scale-105">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
