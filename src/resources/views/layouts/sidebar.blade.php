<div class="relative">
    ...
    <div class="hidden md:flex md:flex-shrink-0">
        <div class="flex flex-col w-64">
            <div class="flex flex-col h-0 flex-1 bg-gradient-to-b from-purple-900 to-purple-800">
                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-8 flex-1 px-2 space-y-1">
                        <a href="{{ route('dashboard') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-purple-700 to-pink-600 text-white shadow-lg' : 'text-purple-200 hover:bg-purple-700 hover:text-white' }} transition-all duration-200">
                        ...
                        <a href="{{ route('productos.index') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('productos.*') ? 'bg-gradient-to-r from-purple-700 to-pink-600 text-white shadow-lg' : 'text-purple-200 hover:bg-purple-700 hover:text-white' }} transition-all duration-200">
                            <svg class="mr-3 h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                            </svg>
                            Productos
                        </a>
                        <a href="{{ route('categorias.index') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('categorias.*') ? 'bg-gradient-to-r from-purple-700 to-pink-600 text-white shadow-lg' : 'text-purple-200 hover:bg-purple-700 hover:text-white' }} transition-all duration-200">
                            <svg class="mr-3 h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex-shrink-0 flex bg-gradient-to-r from-purple-800 to-purple-700 p-4 border-t border-purple-700">
    ...
    <div x-show="sidebarOpen" x-transition:enter="transition-opacity ease-linear duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-linear duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 z-40 md:hidden">
        ...
        <div x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative flex-1 flex flex-col max-w-xs w-full bg-gradient-to-b from-purple-900 to-purple-800">
