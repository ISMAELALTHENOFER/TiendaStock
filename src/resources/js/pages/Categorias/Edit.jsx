...
export default function CategoriasEdit({ categoria, errors = {} }) {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card>
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-4">
            <h2 className="text-white font-bold text-lg">Modificar Categoría</h2>
            <p className="text-amber-100 text-sm">Actualiza los detalles de la categoría</p>
          </div>
